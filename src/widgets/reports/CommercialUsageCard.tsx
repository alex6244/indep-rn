...
export function CommercialUsageCard({ report }: { report: Report }) {
  return (
    <View style={styles.card}>
      <View style={styles.headerRow}>
        <Text style={styles.title}>Коммерческое использование</Text>
        <View style={styles.badge}>
          <Text style={styles.badgeText}>{report.commercialUsage.badgeText}</Text>
        </View>
      </View>

      <View style={styles.items}>
        {report.commercialUsage.items.map((it, idx) => (
